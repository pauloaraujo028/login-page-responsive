...
<div align="center">
  ...
  <h4 align="center">  
    <br />
    <a href="https://github.com/pauloaraujo028/login-page-responsive/issues/new" target="_blank">Relatar Bug</a>
    ·
    <a href="https://github.com/pauloaraujo028/login-page-responsive/issues/new" target="_blank">Recurso de Solicitação</a>
  </h4>
</div>
...
Login Page simples feita com HTML5 & CSS3.

<img width="1493" alt="login-page" src="https://user-images.githubusercontent.com/105018299/193167879-fb62a5c4-8275-4d24-90f4-15dc88908328.jpg">

**Funcionalidades principais:**
* Login Page.
* Design Responsivo.

Login Page simples com design responsivo,  utilizável em todos os dispositivos. Todas funcionalidades estão funcionando perfeitamente, É um projeto excelente, sendo construído com HTML5 & CSS3. Espero que goste.
...
### Clonar-localmente
- Digite essa url: [https://github.com/pauloaraujo028/login-page-responsive](https://github.com/pauloaraujo028/login-page-responsive) no seu navegador.
